...
$MONGODB_CLIENT --port 27020 --eval "rs.initiate( { _id : 'rs0', members: [{ _id: 0, host: '${MONGO_REPLSET_HOST:-localhost}:27020' }, { _id: 1, host: '${MONGO_REPLSET_HOST:-localhost}:27021', priority: 0 }]})"
tail -f /dev/null
