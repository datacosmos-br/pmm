...
const (
	...
	queryLogColumnType = "type"
	zeroUInt64SQL      = "toUInt64(0)"
...
var requiredColumns = []string{
	queryLogColumnType, "event_time", "query_id", "query",
...
func buildSelectList(columns map[string]struct{}) string {
	...
	defaults := map[string]string{
		...
		"normalized_query_hash":   zeroUInt64SQL,
		"query_kind":              "''",
		"result_rows":             zeroUInt64SQL,
		"result_bytes":            zeroUInt64SQL,
		"written_rows":            zeroUInt64SQL,
		"written_bytes":           zeroUInt64SQL,
	}
	order := []string{
		queryLogColumnType, "event_time", "event_time_microseconds", "query_id", "query",
