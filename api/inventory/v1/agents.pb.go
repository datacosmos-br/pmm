...
const (
	...
	AgentType_AGENT_TYPE_CLICKHOUSE_EXPORTER                AgentType = 21
	AgentType_AGENT_TYPE_QAN_CLICKHOUSE_QUERYLOG_AGENT      AgentType = 22
)
...
var (
	AgentType_name = map[int32]string{
		...
		21: "AGENT_TYPE_CLICKHOUSE_EXPORTER",
		22: "AGENT_TYPE_QAN_CLICKHOUSE_QUERYLOG_AGENT",
	}
	AgentType_value = map[string]int32{
		...
		"AGENT_TYPE_CLICKHOUSE_EXPORTER":                21,
		"AGENT_TYPE_QAN_CLICKHOUSE_QUERYLOG_AGENT":      22,
	}
)
...
type ListAgentsResponse struct {
	...
	ClickhouseExporter              []*ClickHouseExporter              `protobuf:"bytes,21,rep,name=clickhouse_exporter,json=clickhouseExporter,proto3" json:"clickhouse_exporter,omitempty"`
	QanClickhouseQuerylogAgent      []*QANClickHouseQueryLogAgent      `protobuf:"bytes,22,rep,name=qan_clickhouse_querylog_agent,json=qanClickhouseQuerylogAgent,proto3" json:"qan_clickhouse_querylog_agent,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
type GetAgentResponse_ClickhouseExporter struct {
	ClickhouseExporter *ClickHouseExporter `protobuf:"bytes,21,opt,name=clickhouse_exporter,json=clickhouseExporter,proto3,oneof"`
}

type GetAgentResponse_QanClickhouseQuerylogAgent struct {
	QanClickhouseQuerylogAgent *QANClickHouseQueryLogAgent `protobuf:"bytes,22,opt,name=qan_clickhouse_querylog_agent,json=qanClickhouseQuerylogAgent,proto3,oneof"`
}
...
type AddAgentRequest_ClickhouseExporter struct {
	ClickhouseExporter *AddClickHouseExporterParams `protobuf:"bytes,19,opt,name=clickhouse_exporter,json=clickhouseExporter,proto3,oneof"`
}

type AddAgentRequest_QanClickhouseQuerylogAgent struct {
	QanClickhouseQuerylogAgent *AddQANClickHouseQueryLogAgentParams `protobuf:"bytes,20,opt,name=qan_clickhouse_querylog_agent,json=qanClickhouseQuerylogAgent,proto3,oneof"`
}
...
type ChangeAgentRequest_ClickhouseExporter struct {
	ClickhouseExporter *ChangeClickHouseExporterParams `protobuf:"bytes,20,opt,name=clickhouse_exporter,json=clickhouseExporter,proto3,oneof"`
}

type ChangeAgentRequest_QanClickhouseQuerylogAgent struct {
	QanClickhouseQuerylogAgent *ChangeQANClickHouseQueryLogAgentParams `protobuf:"bytes,21,opt,name=qan_clickhouse_querylog_agent,json=qanClickhouseQuerylogAgent,proto3,oneof"`
}
...
const file_inventory_v1_agents_proto_rawDesc = "" +
	...
	"\n" +
	"agent_type\x18\x04 \x01(\x0e2\x17.inventory.v1.AgentTypeR\tagentType\"\x9c\x0e\n" +
	...
	"\x0eotel_collector\x18\x14 \x03(\v2\x1b.inventory.v1.OtelCollectorR\rotelCollector\x12Q\n" +
	"\x13clickhouse_exporter\x18\x15 \x03(\v2 .inventory.v1.ClickHouseExporterR\x12clickhouseExporter\x12k\n" +
	"\x1dqan_clickhouse_querylog_agent\x18\x16 \x03(\v2(.inventory.v1.QANClickHouseQueryLogAgentR\x1aqanClickhouseQuerylogAgent\"5\n" +
	"\x0fGetAgentRequest\x12\"\n" +
	"\bagent_id\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10$R\aagentId\"\xce\x0e\n" +
	...
	"\x0eotel_collector\x18\x14 \x01(\v2\x1b.inventory.v1.OtelCollectorH\x00R\rotelCollector\x12S\n" +
	"\x13clickhouse_exporter\x18\x15 \x01(\v2 .inventory.v1.ClickHouseExporterH\x00R\x12clickhouseExporter\x12m\n" +
	"\x1dqan_clickhouse_querylog_agent\x18\x16 \x01(\v2(.inventory.v1.QANClickHouseQueryLogAgentH\x00R\x1aqanClickhouseQuerylogAgentB\a\n" +
	"\x05agent\"O\n" +
	...
	"\x1cagent_config_log_lines_count\x18\x02 \x01(\rR\x18agentConfigLogLinesCount\"\x93\x0f\n" +
	...
	"\x0eotel_collector\x18\x12 \x01(\v2$.inventory.v1.AddOtelCollectorParamsH\x00R\rotelCollector\x12\\\n" +
	"\x13clickhouse_exporter\x18\x13 \x01(\v2).inventory.v1.AddClickHouseExporterParamsH\x00R\x12clickhouseExporter\x12v\n" +
	"\x1dqan_clickhouse_querylog_agent\x18\x14 \x01(\v21.inventory.v1.AddQANClickHouseQueryLogAgentParamsH\x00R\x1aqanClickhouseQuerylogAgentB\a\n" +
	"\x05agent\"\xde\r\n" +
	...
	"\x0eotel_collector\x18\x12 \x01(\v2\x1b.inventory.v1.OtelCollectorH\x00R\rotelCollector\x12S\n" +
	...
	"\x0eotel_collector\x18\x13 \x01(\v2'.inventory.v1.ChangeOtelCollectorParamsH\x00R\rotelCollector\x12_\n" +
	"\x13clickhouse_exporter\x18\x14 \x01(\v2,.inventory.v1.ChangeClickHouseExporterParamsH\x00R\x12clickhouseExporter\x12y\n" +
	"\x1dqan_clickhouse_querylog_agent\x18\x15 \x01(\v24.inventory.v1.ChangeQANClickHouseQueryLogAgentParamsH\x00R\x1aqanClickhouseQuerylogAgentB\a\n" +
	"\x05agent\"\xe7\r\n" +
	...
	"\x0eotel_collector\x18\x13 \x01(\v2\x1b.inventory.v1.OtelCollectorH\x00R\rotelCollector\x12S\n" +
	...
	"\x13RemoveAgentResponse*\xc1\x06\n" +
	"\tAgentType\x12\x1a\n" +
	...
	"\x19AGENT_TYPE_OTEL_COLLECTOR\x10\x14\x12\"\n" +
	"\x1eAGENT_TYPE_CLICKHOUSE_EXPORTER\x10\x15\x12,\n" +
	"(AGENT_TYPE_QAN_CLICKHOUSE_QUERYLOG_AGENT\x10\x162\x83\t\n" +
...
var file_inventory_v1_agents_proto_msgTypes = make([]protoimpl.MessageInfo, 124)
var file_inventory_v1_agents_proto_goTypes = []any{
	...
	(*ClickHouseExporter)(nil),                          // 11: inventory.v1.ClickHouseExporter
	(*QANClickHouseQueryLogAgent)(nil),                  // 12: inventory.v1.QANClickHouseQueryLogAgent
	...
	(*RTAOptions)(nil),                                  // 17: inventory.v1.RTAOptions
	(*RTAMongoDBAgent)(nil),                             // 18: inventory.v1.RTAMongoDBAgent
	(*QANPostgreSQLPgStatementsAgent)(nil),              // 19: inventory.v1.QANPostgreSQLPgStatementsAgent
	(*QANPostgreSQLPgStatMonitorAgent)(nil),             // 20: inventory.v1.QANPostgreSQLPgStatMonitorAgent
	(*RDSExporter)(nil),                                 // 21: inventory.v1.RDSExporter
	(*ExternalExporter)(nil),                            // 22: inventory.v1.ExternalExporter
	(*AzureDatabaseExporter)(nil),                       // 23: inventory.v1.AzureDatabaseExporter
	(*ChangeCommonAgentParams)(nil),                     // 24: inventory.v1.ChangeCommonAgentParams
	(*ListAgentsRequest)(nil),                           // 25: inventory.v1.ListAgentsRequest
	(*ListAgentsResponse)(nil),                          // 26: inventory.v1.ListAgentsResponse
	(*GetAgentRequest)(nil),                             // 27: inventory.v1.GetAgentRequest
	(*GetAgentResponse)(nil),                            // 28: inventory.v1.GetAgentResponse
	(*GetAgentLogsRequest)(nil),                         // 29: inventory.v1.GetAgentLogsRequest
	(*GetAgentLogsResponse)(nil),                        // 30: inventory.v1.GetAgentLogsResponse
	(*AddAgentRequest)(nil),                             // 31: inventory.v1.AddAgentRequest
	(*AddAgentResponse)(nil),                            // 32: inventory.v1.AddAgentResponse
	(*ChangeAgentRequest)(nil),                          // 33: inventory.v1.ChangeAgentRequest
	(*ChangeAgentResponse)(nil),                         // 34: inventory.v1.ChangeAgentResponse
	(*AddPMMAgentParams)(nil),                           // 35: inventory.v1.AddPMMAgentParams
	(*AddNodeExporterParams)(nil),                       // 36: inventory.v1.AddNodeExporterParams
	(*ChangeNodeExporterParams)(nil),                    // 37: inventory.v1.ChangeNodeExporterParams
	(*AddMySQLdExporterParams)(nil),                     // 38: inventory.v1.AddMySQLdExporterParams
	(*ChangeMySQLdExporterParams)(nil),                  // 39: inventory.v1.ChangeMySQLdExporterParams
	(*AddMongoDBExporterParams)(nil),                    // 40: inventory.v1.AddMongoDBExporterParams
	(*ChangeMongoDBExporterParams)(nil),                 // 41: inventory.v1.ChangeMongoDBExporterParams
	(*AddPostgresExporterParams)(nil),                   // 42: inventory.v1.AddPostgresExporterParams
	(*ChangePostgresExporterParams)(nil),                // 43: inventory.v1.ChangePostgresExporterParams
	(*AddProxySQLExporterParams)(nil),                   // 44: inventory.v1.AddProxySQLExporterParams
	(*ChangeProxySQLExporterParams)(nil),                // 45: inventory.v1.ChangeProxySQLExporterParams
	(*AddQANMySQLPerfSchemaAgentParams)(nil),            // 46: inventory.v1.AddQANMySQLPerfSchemaAgentParams
	(*ChangeQANMySQLPerfSchemaAgentParams)(nil),         // 47: inventory.v1.ChangeQANMySQLPerfSchemaAgentParams
	(*AddQANMySQLSlowlogAgentParams)(nil),               // 48: inventory.v1.AddQANMySQLSlowlogAgentParams
	(*ChangeQANMySQLSlowlogAgentParams)(nil),            // 49: inventory.v1.ChangeQANMySQLSlowlogAgentParams
	(*AddQANMongoDBProfilerAgentParams)(nil),            // 50: inventory.v1.AddQANMongoDBProfilerAgentParams
	(*ChangeQANMongoDBProfilerAgentParams)(nil),         // 51: inventory.v1.ChangeQANMongoDBProfilerAgentParams
	(*AddQANMongoDBMongologAgentParams)(nil),            // 52: inventory.v1.AddQANMongoDBMongologAgentParams
	(*ChangeQANMongoDBMongologAgentParams)(nil),         // 53: inventory.v1.ChangeQANMongoDBMongologAgentParams
	(*AddQANPostgreSQLPgStatementsAgentParams)(nil),     // 54: inventory.v1.AddQANPostgreSQLPgStatementsAgentParams
	(*ChangeQANPostgreSQLPgStatementsAgentParams)(nil),  // 55: inventory.v1.ChangeQANPostgreSQLPgStatementsAgentParams
	(*AddQANPostgreSQLPgStatMonitorAgentParams)(nil),    // 56: inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams
	(*ChangeQANPostgreSQLPgStatMonitorAgentParams)(nil), // 57: inventory.v1.ChangeQANPostgreSQLPgStatMonitorAgentParams
	(*AddRDSExporterParams)(nil),                        // 58: inventory.v1.AddRDSExporterParams
	(*ChangeRDSExporterParams)(nil),                     // 59: inventory.v1.ChangeRDSExporterParams
	(*AddExternalExporterParams)(nil),                   // 60: inventory.v1.AddExternalExporterParams
	(*ChangeExternalExporterParams)(nil),                // 61: inventory.v1.ChangeExternalExporterParams
	(*AddAzureDatabaseExporterParams)(nil),              // 62: inventory.v1.AddAzureDatabaseExporterParams
	(*ChangeAzureDatabaseExporterParams)(nil),           // 63: inventory.v1.ChangeAzureDatabaseExporterParams
	(*ChangeNomadAgentParams)(nil),                      // 64: inventory.v1.ChangeNomadAgentParams
	(*AddValkeyExporterParams)(nil),                     // 65: inventory.v1.AddValkeyExporterParams
	(*ChangeValkeyExporterParams)(nil),                  // 66: inventory.v1.ChangeValkeyExporterParams
	(*AddClickHouseExporterParams)(nil),                 // 67: inventory.v1.AddClickHouseExporterParams
	(*ChangeClickHouseExporterParams)(nil),              // 68: inventory.v1.ChangeClickHouseExporterParams
	(*AddQANClickHouseQueryLogAgentParams)(nil),         // 69: inventory.v1.AddQANClickHouseQueryLogAgentParams
	(*ChangeQANClickHouseQueryLogAgentParams)(nil),      // 70: inventory.v1.ChangeQANClickHouseQueryLogAgentParams
	(*AddRTAMongoDBAgentParams)(nil),                    // 71: inventory.v1.AddRTAMongoDBAgentParams
	(*LogSource)(nil),                                   // 72: inventory.v1.LogSource
	(*AddOtelCollectorParams)(nil),                      // 73: inventory.v1.AddOtelCollectorParams
	(*ChangeOtelCollectorParams)(nil),                   // 74: inventory.v1.ChangeOtelCollectorParams
	(*ChangeRTAMongoDBAgentParams)(nil),                 // 75: inventory.v1.ChangeRTAMongoDBAgentParams
	(*RemoveAgentRequest)(nil),                          // 76: inventory.v1.RemoveAgentRequest
	(*RemoveAgentResponse)(nil),                         // 77: inventory.v1.RemoveAgentResponse
	nil,                                                 // 78: inventory.v1.PMMAgent.CustomLabelsEntry
	nil,                                                 // 79: inventory.v1.OtelCollector.CustomLabelsEntry
	nil,                                                 // 80: inventory.v1.NodeExporter.CustomLabelsEntry
	nil,                                                 // 81: inventory.v1.MySQLdExporter.CustomLabelsEntry
	nil,                                                 // 82: inventory.v1.MySQLdExporter.ExtraDsnParamsEntry
	nil,                                                 // 83: inventory.v1.MongoDBExporter.CustomLabelsEntry
	nil,                                                 // 84: inventory.v1.PostgresExporter.CustomLabelsEntry
	nil,                                                 // 85: inventory.v1.ProxySQLExporter.CustomLabelsEntry
	nil,                                                 // 86: inventory.v1.ValkeyExporter.CustomLabelsEntry
	nil,                                                 // 87: inventory.v1.ClickHouseExporter.CustomLabelsEntry
	nil,                                                 // 88: inventory.v1.QANClickHouseQueryLogAgent.CustomLabelsEntry
	nil,                                                 // 89: inventory.v1.QANMySQLPerfSchemaAgent.CustomLabelsEntry
	nil,                                                 // 90: inventory.v1.QANMySQLPerfSchemaAgent.ExtraDsnParamsEntry
	nil,                                                 // 91: inventory.v1.QANMySQLSlowlogAgent.CustomLabelsEntry
	nil,                                                 // 92: inventory.v1.QANMySQLSlowlogAgent.ExtraDsnParamsEntry
	nil,                                                 // 93: inventory.v1.QANMongoDBProfilerAgent.CustomLabelsEntry
	nil,                                                 // 94: inventory.v1.QANMongoDBMongologAgent.CustomLabelsEntry
	nil,                                                 // 95: inventory.v1.RTAMongoDBAgent.CustomLabelsEntry
	nil,                                                 // 96: inventory.v1.QANPostgreSQLPgStatementsAgent.CustomLabelsEntry
	nil,                                                 // 97: inventory.v1.QANPostgreSQLPgStatMonitorAgent.CustomLabelsEntry
	nil,                                                 // 98: inventory.v1.RDSExporter.CustomLabelsEntry
	nil,                                                 // 99: inventory.v1.ExternalExporter.CustomLabelsEntry
	nil,                                                 // 100: inventory.v1.AzureDatabaseExporter.CustomLabelsEntry
	nil,                                                 // 101: inventory.v1.AddPMMAgentParams.CustomLabelsEntry
	nil,                                                 // 102: inventory.v1.AddNodeExporterParams.CustomLabelsEntry
	nil,                                                 // 103: inventory.v1.AddMySQLdExporterParams.CustomLabelsEntry
	nil,                                                 // 104: inventory.v1.AddMySQLdExporterParams.ExtraDsnParamsEntry
	nil,                                                 // 105: inventory.v1.AddMongoDBExporterParams.CustomLabelsEntry
	nil,                                                 // 106: inventory.v1.AddPostgresExporterParams.CustomLabelsEntry
	nil,                                                 // 107: inventory.v1.AddProxySQLExporterParams.CustomLabelsEntry
	nil,                                                 // 108: inventory.v1.AddQANMySQLPerfSchemaAgentParams.CustomLabelsEntry
	nil,                                                 // 109: inventory.v1.AddQANMySQLPerfSchemaAgentParams.ExtraDsnParamsEntry
	nil,                                                 // 110: inventory.v1.AddQANMySQLSlowlogAgentParams.CustomLabelsEntry
	nil,                                                 // 111: inventory.v1.AddQANMySQLSlowlogAgentParams.ExtraDsnParamsEntry
	nil,                                                 // 112: inventory.v1.AddQANMongoDBProfilerAgentParams.CustomLabelsEntry
	nil,                                                 // 113: inventory.v1.AddQANMongoDBMongologAgentParams.CustomLabelsEntry
	nil,                                                 // 114: inventory.v1.AddQANPostgreSQLPgStatementsAgentParams.CustomLabelsEntry
	nil,                                                 // 115: inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams.CustomLabelsEntry
	nil,                                                 // 116: inventory.v1.AddRDSExporterParams.CustomLabelsEntry
	nil,                                                 // 117: inventory.v1.AddExternalExporterParams.CustomLabelsEntry
	nil,                                                 // 118: inventory.v1.AddAzureDatabaseExporterParams.CustomLabelsEntry
	nil,                                                 // 119: inventory.v1.AddValkeyExporterParams.CustomLabelsEntry
	nil,                                                 // 120: inventory.v1.AddClickHouseExporterParams.CustomLabelsEntry
	nil,                                                 // 121: inventory.v1.AddQANClickHouseQueryLogAgentParams.CustomLabelsEntry
	nil,                                                 // 122: inventory.v1.AddRTAMongoDBAgentParams.CustomLabelsEntry
	nil,                                                 // 123: inventory.v1.AddOtelCollectorParams.CustomLabelsEntry
	nil,                                                 // 124: inventory.v1.ChangeOtelCollectorParams.MergeLabelsEntry
	(AgentStatus)(0),                                    // 125: inventory.v1.AgentStatus
	(LogLevel)(0),                                       // 126: inventory.v1.LogLevel
	(*common.MetricsResolutions)(nil),                   // 127: common.MetricsResolutions
	(*durationpb.Duration)(nil),                         // 128: google.protobuf.Duration
	(*common.StringMap)(nil),                            // 129: common.StringMap
}
var file_inventory_v1_agents_proto_depIdxs = []int32{
	78,  // 0: inventory.v1.PMMAgent.custom_labels:type_name -> inventory.v1.PMMAgent.CustomLabelsEntry
	125, // 1: inventory.v1.VMAgent.status:type_name -> inventory.v1.AgentStatus
	125, // 2: inventory.v1.NomadAgent.status:type_name -> inventory.v1.AgentStatus
	79,  // 3: inventory.v1.OtelCollector.custom_labels:type_name -> inventory.v1.OtelCollector.CustomLabelsEntry
	125, // 4: inventory.v1.OtelCollector.status:type_name -> inventory.v1.AgentStatus
	80,  // 5: inventory.v1.NodeExporter.custom_labels:type_name -> inventory.v1.NodeExporter.CustomLabelsEntry
	125, // 6: inventory.v1.NodeExporter.status:type_name -> inventory.v1.AgentStatus
	126, // 7: inventory.v1.NodeExporter.log_level:type_name -> inventory.v1.LogLevel
	127, // 8: inventory.v1.NodeExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	81,  // 9: inventory.v1.MySQLdExporter.custom_labels:type_name -> inventory.v1.MySQLdExporter.CustomLabelsEntry
	125, // 10: inventory.v1.MySQLdExporter.status:type_name -> inventory.v1.AgentStatus
	126, // 11: inventory.v1.MySQLdExporter.log_level:type_name -> inventory.v1.LogLevel
	127, // 12: inventory.v1.MySQLdExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	82,  // 13: inventory.v1.MySQLdExporter.extra_dsn_params:type_name -> inventory.v1.MySQLdExporter.ExtraDsnParamsEntry
	128, // 14: inventory.v1.MySQLdExporter.connection_timeout:type_name -> google.protobuf.Duration
	83,  // 15: inventory.v1.MongoDBExporter.custom_labels:type_name -> inventory.v1.MongoDBExporter.CustomLabelsEntry
	125, // 16: inventory.v1.MongoDBExporter.status:type_name -> inventory.v1.AgentStatus
	126, // 17: inventory.v1.MongoDBExporter.log_level:type_name -> inventory.v1.LogLevel
	127, // 18: inventory.v1.MongoDBExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	128, // 19: inventory.v1.MongoDBExporter.connection_timeout:type_name -> google.protobuf.Duration
	84,  // 20: inventory.v1.PostgresExporter.custom_labels:type_name -> inventory.v1.PostgresExporter.CustomLabelsEntry
	125, // 21: inventory.v1.PostgresExporter.status:type_name -> inventory.v1.AgentStatus
	126, // 22: inventory.v1.PostgresExporter.log_level:type_name -> inventory.v1.LogLevel
	127, // 23: inventory.v1.PostgresExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	128, // 24: inventory.v1.PostgresExporter.connection_timeout:type_name -> google.protobuf.Duration
	85,  // 25: inventory.v1.ProxySQLExporter.custom_labels:type_name -> inventory.v1.ProxySQLExporter.CustomLabelsEntry
	125, // 26: inventory.v1.ProxySQLExporter.status:type_name -> inventory.v1.AgentStatus
	126, // 27: inventory.v1.ProxySQLExporter.log_level:type_name -> inventory.v1.LogLevel
	127, // 28: inventory.v1.ProxySQLExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	128, // 29: inventory.v1.ProxySQLExporter.connection_timeout:type_name -> google.protobuf.Duration
	86,  // 30: inventory.v1.ValkeyExporter.custom_labels:type_name -> inventory.v1.ValkeyExporter.CustomLabelsEntry
	125, // 31: inventory.v1.ValkeyExporter.status:type_name -> inventory.v1.AgentStatus
	127, // 32: inventory.v1.ValkeyExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	128, // 33: inventory.v1.ValkeyExporter.connection_timeout:type_name -> google.protobuf.Duration
	87,  // 34: inventory.v1.ClickHouseExporter.custom_labels:type_name -> inventory.v1.ClickHouseExporter.CustomLabelsEntry
	125, // 35: inventory.v1.ClickHouseExporter.status:type_name -> inventory.v1.AgentStatus
	127, // 36: inventory.v1.ClickHouseExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	88,  // 37: inventory.v1.QANClickHouseQueryLogAgent.custom_labels:type_name -> inventory.v1.QANClickHouseQueryLogAgent.CustomLabelsEntry
	125, // 38: inventory.v1.QANClickHouseQueryLogAgent.status:type_name -> inventory.v1.AgentStatus
	126, // 39: inventory.v1.QANClickHouseQueryLogAgent.log_level:type_name -> inventory.v1.LogLevel
	89,  // 40: inventory.v1.QANMySQLPerfSchemaAgent.custom_labels:type_name -> inventory.v1.QANMySQLPerfSchemaAgent.CustomLabelsEntry
	125, // 41: inventory.v1.QANMySQLPerfSchemaAgent.status:type_name -> inventory.v1.AgentStatus
	126, // 42: inventory.v1.QANMySQLPerfSchemaAgent.log_level:type_name -> inventory.v1.LogLevel
	90,  // 43: inventory.v1.QANMySQLPerfSchemaAgent.extra_dsn_params:type_name -> inventory.v1.QANMySQLPerfSchemaAgent.ExtraDsnParamsEntry
	91,  // 44: inventory.v1.QANMySQLSlowlogAgent.custom_labels:type_name -> inventory.v1.QANMySQLSlowlogAgent.CustomLabelsEntry
	125, // 45: inventory.v1.QANMySQLSlowlogAgent.status:type_name -> inventory.v1.AgentStatus
	126, // 46: inventory.v1.QANMySQLSlowlogAgent.log_level:type_name -> inventory.v1.LogLevel
	92,  // 47: inventory.v1.QANMySQLSlowlogAgent.extra_dsn_params:type_name -> inventory.v1.QANMySQLSlowlogAgent.ExtraDsnParamsEntry
	93,  // 48: inventory.v1.QANMongoDBProfilerAgent.custom_labels:type_name -> inventory.v1.QANMongoDBProfilerAgent.CustomLabelsEntry
	125, // 49: inventory.v1.QANMongoDBProfilerAgent.status:type_name -> inventory.v1.AgentStatus
	126, // 50: inventory.v1.QANMongoDBProfilerAgent.log_level:type_name -> inventory.v1.LogLevel
	94,  // 51: inventory.v1.QANMongoDBMongologAgent.custom_labels:type_name -> inventory.v1.QANMongoDBMongologAgent.CustomLabelsEntry
	125, // 52: inventory.v1.QANMongoDBMongologAgent.status:type_name -> inventory.v1.AgentStatus
	126, // 53: inventory.v1.QANMongoDBMongologAgent.log_level:type_name -> inventory.v1.LogLevel
	128, // 54: inventory.v1.RTAOptions.collect_interval:type_name -> google.protobuf.Duration
	95,  // 55: inventory.v1.RTAMongoDBAgent.custom_labels:type_name -> inventory.v1.RTAMongoDBAgent.CustomLabelsEntry
	17,  // 56: inventory.v1.RTAMongoDBAgent.rta_options:type_name -> inventory.v1.RTAOptions
	125, // 57: inventory.v1.RTAMongoDBAgent.status:type_name -> inventory.v1.AgentStatus
	126, // 58: inventory.v1.RTAMongoDBAgent.log_level:type_name -> inventory.v1.LogLevel
	96,  // 59: inventory.v1.QANPostgreSQLPgStatementsAgent.custom_labels:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent.CustomLabelsEntry
	125, // 60: inventory.v1.QANPostgreSQLPgStatementsAgent.status:type_name -> inventory.v1.AgentStatus
	126, // 61: inventory.v1.QANPostgreSQLPgStatementsAgent.log_level:type_name -> inventory.v1.LogLevel
	97,  // 62: inventory.v1.QANPostgreSQLPgStatMonitorAgent.custom_labels:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent.CustomLabelsEntry
	125, // 63: inventory.v1.QANPostgreSQLPgStatMonitorAgent.status:type_name -> inventory.v1.AgentStatus
	126, // 64: inventory.v1.QANPostgreSQLPgStatMonitorAgent.log_level:type_name -> inventory.v1.LogLevel
	98,  // 65: inventory.v1.RDSExporter.custom_labels:type_name -> inventory.v1.RDSExporter.CustomLabelsEntry
	125, // 66: inventory.v1.RDSExporter.status:type_name -> inventory.v1.AgentStatus
	126, // 67: inventory.v1.RDSExporter.log_level:type_name -> inventory.v1.LogLevel
	127, // 68: inventory.v1.RDSExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	99,  // 69: inventory.v1.ExternalExporter.custom_labels:type_name -> inventory.v1.ExternalExporter.CustomLabelsEntry
	127, // 70: inventory.v1.ExternalExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	125, // 71: inventory.v1.ExternalExporter.status:type_name -> inventory.v1.AgentStatus
	100, // 72: inventory.v1.AzureDatabaseExporter.custom_labels:type_name -> inventory.v1.AzureDatabaseExporter.CustomLabelsEntry
	125, // 73: inventory.v1.AzureDatabaseExporter.status:type_name -> inventory.v1.AgentStatus
	126, // 74: inventory.v1.AzureDatabaseExporter.log_level:type_name -> inventory.v1.LogLevel
	127, // 75: inventory.v1.AzureDatabaseExporter.metrics_resolutions:type_name -> common.MetricsResolutions
	129, // 76: inventory.v1.ChangeCommonAgentParams.custom_labels:type_name -> common.StringMap
	127, // 77: inventory.v1.ChangeCommonAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	...
	5,   // 81: inventory.v1.ListAgentsResponse.node_exporter:type_name -> inventory.v1.NodeExporter
	6,   // 82: inventory.v1.ListAgentsResponse.mysqld_exporter:type_name -> inventory.v1.MySQLdExporter
	7,   // 83: inventory.v1.ListAgentsResponse.mongodb_exporter:type_name -> inventory.v1.MongoDBExporter
	8,   // 84: inventory.v1.ListAgentsResponse.postgres_exporter:type_name -> inventory.v1.PostgresExporter
	9,   // 85: inventory.v1.ListAgentsResponse.proxysql_exporter:type_name -> inventory.v1.ProxySQLExporter
	13,  // 86: inventory.v1.ListAgentsResponse.qan_mysql_perfschema_agent:type_name -> inventory.v1.QANMySQLPerfSchemaAgent
	14,  // 87: inventory.v1.ListAgentsResponse.qan_mysql_slowlog_agent:type_name -> inventory.v1.QANMySQLSlowlogAgent
	15,  // 88: inventory.v1.ListAgentsResponse.qan_mongodb_profiler_agent:type_name -> inventory.v1.QANMongoDBProfilerAgent
	16,  // 89: inventory.v1.ListAgentsResponse.qan_mongodb_mongolog_agent:type_name -> inventory.v1.QANMongoDBMongologAgent
	19,  // 90: inventory.v1.ListAgentsResponse.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent
	20,  // 91: inventory.v1.ListAgentsResponse.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent
	22,  // 92: inventory.v1.ListAgentsResponse.external_exporter:type_name -> inventory.v1.ExternalExporter
	21,  // 93: inventory.v1.ListAgentsResponse.rds_exporter:type_name -> inventory.v1.RDSExporter
	23,  // 94: inventory.v1.ListAgentsResponse.azure_database_exporter:type_name -> inventory.v1.AzureDatabaseExporter
	3,   // 95: inventory.v1.ListAgentsResponse.nomad_agent:type_name -> inventory.v1.NomadAgent
	10,  // 96: inventory.v1.ListAgentsResponse.valkey_exporter:type_name -> inventory.v1.ValkeyExporter
	18,  // 97: inventory.v1.ListAgentsResponse.rta_mongodb_agent:type_name -> inventory.v1.RTAMongoDBAgent
	4,   // 98: inventory.v1.ListAgentsResponse.otel_collector:type_name -> inventory.v1.OtelCollector
	11,  // 99: inventory.v1.ListAgentsResponse.clickhouse_exporter:type_name -> inventory.v1.ClickHouseExporter
	12,  // 100: inventory.v1.ListAgentsResponse.qan_clickhouse_querylog_agent:type_name -> inventory.v1.QANClickHouseQueryLogAgent
	1,   // 101: inventory.v1.GetAgentResponse.pmm_agent:type_name -> inventory.v1.PMMAgent
	2,   // 102: inventory.v1.GetAgentResponse.vmagent:type_name -> inventory.v1.VMAgent
	5,   // 103: inventory.v1.GetAgentResponse.node_exporter:type_name -> inventory.v1.NodeExporter
	6,   // 104: inventory.v1.GetAgentResponse.mysqld_exporter:type_name -> inventory.v1.MySQLdExporter
	7,   // 105: inventory.v1.GetAgentResponse.mongodb_exporter:type_name -> inventory.v1.MongoDBExporter
	8,   // 106: inventory.v1.GetAgentResponse.postgres_exporter:type_name -> inventory.v1.PostgresExporter
	9,   // 107: inventory.v1.GetAgentResponse.proxysql_exporter:type_name -> inventory.v1.ProxySQLExporter
	13,  // 108: inventory.v1.GetAgentResponse.qan_mysql_perfschema_agent:type_name -> inventory.v1.QANMySQLPerfSchemaAgent
	14,  // 109: inventory.v1.GetAgentResponse.qan_mysql_slowlog_agent:type_name -> inventory.v1.QANMySQLSlowlogAgent
	15,  // 110: inventory.v1.GetAgentResponse.qan_mongodb_profiler_agent:type_name -> inventory.v1.QANMongoDBProfilerAgent
	16,  // 111: inventory.v1.GetAgentResponse.qan_mongodb_mongolog_agent:type_name -> inventory.v1.QANMongoDBMongologAgent
	19,  // 112: inventory.v1.GetAgentResponse.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent
	20,  // 113: inventory.v1.GetAgentResponse.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent
	22,  // 114: inventory.v1.GetAgentResponse.external_exporter:type_name -> inventory.v1.ExternalExporter
	21,  // 115: inventory.v1.GetAgentResponse.rds_exporter:type_name -> inventory.v1.RDSExporter
	23,  // 116: inventory.v1.GetAgentResponse.azure_database_exporter:type_name -> inventory.v1.AzureDatabaseExporter
	3,   // 117: inventory.v1.GetAgentResponse.nomad_agent:type_name -> inventory.v1.NomadAgent
	10,  // 118: inventory.v1.GetAgentResponse.valkey_exporter:type_name -> inventory.v1.ValkeyExporter
	18,  // 119: inventory.v1.GetAgentResponse.rta_mongodb_agent:type_name -> inventory.v1.RTAMongoDBAgent
	4,   // 120: inventory.v1.GetAgentResponse.otel_collector:type_name -> inventory.v1.OtelCollector
	11,  // 121: inventory.v1.GetAgentResponse.clickhouse_exporter:type_name -> inventory.v1.ClickHouseExporter
	12,  // 122: inventory.v1.GetAgentResponse.qan_clickhouse_querylog_agent:type_name -> inventory.v1.QANClickHouseQueryLogAgent
	35,  // 123: inventory.v1.AddAgentRequest.pmm_agent:type_name -> inventory.v1.AddPMMAgentParams
	36,  // 124: inventory.v1.AddAgentRequest.node_exporter:type_name -> inventory.v1.AddNodeExporterParams
	38,  // 125: inventory.v1.AddAgentRequest.mysqld_exporter:type_name -> inventory.v1.AddMySQLdExporterParams
	40,  // 126: inventory.v1.AddAgentRequest.mongodb_exporter:type_name -> inventory.v1.AddMongoDBExporterParams
	42,  // 127: inventory.v1.AddAgentRequest.postgres_exporter:type_name -> inventory.v1.AddPostgresExporterParams
	44,  // 128: inventory.v1.AddAgentRequest.proxysql_exporter:type_name -> inventory.v1.AddProxySQLExporterParams
	60,  // 129: inventory.v1.AddAgentRequest.external_exporter:type_name -> inventory.v1.AddExternalExporterParams
	58,  // 130: inventory.v1.AddAgentRequest.rds_exporter:type_name -> inventory.v1.AddRDSExporterParams
	62,  // 131: inventory.v1.AddAgentRequest.azure_database_exporter:type_name -> inventory.v1.AddAzureDatabaseExporterParams
	46,  // 132: inventory.v1.AddAgentRequest.qan_mysql_perfschema_agent:type_name -> inventory.v1.AddQANMySQLPerfSchemaAgentParams
	48,  // 133: inventory.v1.AddAgentRequest.qan_mysql_slowlog_agent:type_name -> inventory.v1.AddQANMySQLSlowlogAgentParams
	50,  // 134: inventory.v1.AddAgentRequest.qan_mongodb_profiler_agent:type_name -> inventory.v1.AddQANMongoDBProfilerAgentParams
	52,  // 135: inventory.v1.AddAgentRequest.qan_mongodb_mongolog_agent:type_name -> inventory.v1.AddQANMongoDBMongologAgentParams
	54,  // 136: inventory.v1.AddAgentRequest.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.AddQANPostgreSQLPgStatementsAgentParams
	56,  // 137: inventory.v1.AddAgentRequest.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams
	65,  // 138: inventory.v1.AddAgentRequest.valkey_exporter:type_name -> inventory.v1.AddValkeyExporterParams
	71,  // 139: inventory.v1.AddAgentRequest.rta_mongodb_agent:type_name -> inventory.v1.AddRTAMongoDBAgentParams
	73,  // 140: inventory.v1.AddAgentRequest.otel_collector:type_name -> inventory.v1.AddOtelCollectorParams
	67,  // 141: inventory.v1.AddAgentRequest.clickhouse_exporter:type_name -> inventory.v1.AddClickHouseExporterParams
	69,  // 142: inventory.v1.AddAgentRequest.qan_clickhouse_querylog_agent:type_name -> inventory.v1.AddQANClickHouseQueryLogAgentParams
	1,   // 143: inventory.v1.AddAgentResponse.pmm_agent:type_name -> inventory.v1.PMMAgent
	5,   // 144: inventory.v1.AddAgentResponse.node_exporter:type_name -> inventory.v1.NodeExporter
	6,   // 145: inventory.v1.AddAgentResponse.mysqld_exporter:type_name -> inventory.v1.MySQLdExporter
	7,   // 146: inventory.v1.AddAgentResponse.mongodb_exporter:type_name -> inventory.v1.MongoDBExporter
	8,   // 147: inventory.v1.AddAgentResponse.postgres_exporter:type_name -> inventory.v1.PostgresExporter
	9,   // 148: inventory.v1.AddAgentResponse.proxysql_exporter:type_name -> inventory.v1.ProxySQLExporter
	22,  // 149: inventory.v1.AddAgentResponse.external_exporter:type_name -> inventory.v1.ExternalExporter
	21,  // 150: inventory.v1.AddAgentResponse.rds_exporter:type_name -> inventory.v1.RDSExporter
	23,  // 151: inventory.v1.AddAgentResponse.azure_database_exporter:type_name -> inventory.v1.AzureDatabaseExporter
	13,  // 152: inventory.v1.AddAgentResponse.qan_mysql_perfschema_agent:type_name -> inventory.v1.QANMySQLPerfSchemaAgent
	14,  // 153: inventory.v1.AddAgentResponse.qan_mysql_slowlog_agent:type_name -> inventory.v1.QANMySQLSlowlogAgent
	15,  // 154: inventory.v1.AddAgentResponse.qan_mongodb_profiler_agent:type_name -> inventory.v1.QANMongoDBProfilerAgent
	16,  // 155: inventory.v1.AddAgentResponse.qan_mongodb_mongolog_agent:type_name -> inventory.v1.QANMongoDBMongologAgent
	19,  // 156: inventory.v1.AddAgentResponse.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent
	20,  // 157: inventory.v1.AddAgentResponse.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent
	10,  // 158: inventory.v1.AddAgentResponse.valkey_exporter:type_name -> inventory.v1.ValkeyExporter
	18,  // 159: inventory.v1.AddAgentResponse.rta_mongodb_agent:type_name -> inventory.v1.RTAMongoDBAgent
	4,   // 160: inventory.v1.AddAgentResponse.otel_collector:type_name -> inventory.v1.OtelCollector
	11,  // 161: inventory.v1.AddAgentResponse.clickhouse_exporter:type_name -> inventory.v1.ClickHouseExporter
	12,  // 162: inventory.v1.AddAgentResponse.qan_clickhouse_querylog_agent:type_name -> inventory.v1.QANClickHouseQueryLogAgent
	37,  // 163: inventory.v1.ChangeAgentRequest.node_exporter:type_name -> inventory.v1.ChangeNodeExporterParams
	39,  // 164: inventory.v1.ChangeAgentRequest.mysqld_exporter:type_name -> inventory.v1.ChangeMySQLdExporterParams
	41,  // 165: inventory.v1.ChangeAgentRequest.mongodb_exporter:type_name -> inventory.v1.ChangeMongoDBExporterParams
	43,  // 166: inventory.v1.ChangeAgentRequest.postgres_exporter:type_name -> inventory.v1.ChangePostgresExporterParams
	45,  // 167: inventory.v1.ChangeAgentRequest.proxysql_exporter:type_name -> inventory.v1.ChangeProxySQLExporterParams
	61,  // 168: inventory.v1.ChangeAgentRequest.external_exporter:type_name -> inventory.v1.ChangeExternalExporterParams
	59,  // 169: inventory.v1.ChangeAgentRequest.rds_exporter:type_name -> inventory.v1.ChangeRDSExporterParams
	63,  // 170: inventory.v1.ChangeAgentRequest.azure_database_exporter:type_name -> inventory.v1.ChangeAzureDatabaseExporterParams
	47,  // 171: inventory.v1.ChangeAgentRequest.qan_mysql_perfschema_agent:type_name -> inventory.v1.ChangeQANMySQLPerfSchemaAgentParams
	49,  // 172: inventory.v1.ChangeAgentRequest.qan_mysql_slowlog_agent:type_name -> inventory.v1.ChangeQANMySQLSlowlogAgentParams
	51,  // 173: inventory.v1.ChangeAgentRequest.qan_mongodb_profiler_agent:type_name -> inventory.v1.ChangeQANMongoDBProfilerAgentParams
	53,  // 174: inventory.v1.ChangeAgentRequest.qan_mongodb_mongolog_agent:type_name -> inventory.v1.ChangeQANMongoDBMongologAgentParams
	55,  // 175: inventory.v1.ChangeAgentRequest.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.ChangeQANPostgreSQLPgStatementsAgentParams
	57,  // 176: inventory.v1.ChangeAgentRequest.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.ChangeQANPostgreSQLPgStatMonitorAgentParams
	64,  // 177: inventory.v1.ChangeAgentRequest.nomad_agent:type_name -> inventory.v1.ChangeNomadAgentParams
	66,  // 178: inventory.v1.ChangeAgentRequest.valkey_exporter:type_name -> inventory.v1.ChangeValkeyExporterParams
	75,  // 179: inventory.v1.ChangeAgentRequest.rta_mongodb_agent:type_name -> inventory.v1.ChangeRTAMongoDBAgentParams
	74,  // 180: inventory.v1.ChangeAgentRequest.otel_collector:type_name -> inventory.v1.ChangeOtelCollectorParams
	68,  // 181: inventory.v1.ChangeAgentRequest.clickhouse_exporter:type_name -> inventory.v1.ChangeClickHouseExporterParams
	70,  // 182: inventory.v1.ChangeAgentRequest.qan_clickhouse_querylog_agent:type_name -> inventory.v1.ChangeQANClickHouseQueryLogAgentParams
	5,   // 183: inventory.v1.ChangeAgentResponse.node_exporter:type_name -> inventory.v1.NodeExporter
	6,   // 184: inventory.v1.ChangeAgentResponse.mysqld_exporter:type_name -> inventory.v1.MySQLdExporter
	7,   // 185: inventory.v1.ChangeAgentResponse.mongodb_exporter:type_name -> inventory.v1.MongoDBExporter
	8,   // 186: inventory.v1.ChangeAgentResponse.postgres_exporter:type_name -> inventory.v1.PostgresExporter
	9,   // 187: inventory.v1.ChangeAgentResponse.proxysql_exporter:type_name -> inventory.v1.ProxySQLExporter
	22,  // 188: inventory.v1.ChangeAgentResponse.external_exporter:type_name -> inventory.v1.ExternalExporter
	21,  // 189: inventory.v1.ChangeAgentResponse.rds_exporter:type_name -> inventory.v1.RDSExporter
	23,  // 190: inventory.v1.ChangeAgentResponse.azure_database_exporter:type_name -> inventory.v1.AzureDatabaseExporter
	13,  // 191: inventory.v1.ChangeAgentResponse.qan_mysql_perfschema_agent:type_name -> inventory.v1.QANMySQLPerfSchemaAgent
	14,  // 192: inventory.v1.ChangeAgentResponse.qan_mysql_slowlog_agent:type_name -> inventory.v1.QANMySQLSlowlogAgent
	15,  // 193: inventory.v1.ChangeAgentResponse.qan_mongodb_profiler_agent:type_name -> inventory.v1.QANMongoDBProfilerAgent
	16,  // 194: inventory.v1.ChangeAgentResponse.qan_mongodb_mongolog_agent:type_name -> inventory.v1.QANMongoDBMongologAgent
	19,  // 195: inventory.v1.ChangeAgentResponse.qan_postgresql_pgstatements_agent:type_name -> inventory.v1.QANPostgreSQLPgStatementsAgent
	20,  // 196: inventory.v1.ChangeAgentResponse.qan_postgresql_pgstatmonitor_agent:type_name -> inventory.v1.QANPostgreSQLPgStatMonitorAgent
	3,   // 197: inventory.v1.ChangeAgentResponse.nomad_agent:type_name -> inventory.v1.NomadAgent
	10,  // 198: inventory.v1.ChangeAgentResponse.valkey_exporter:type_name -> inventory.v1.ValkeyExporter
	18,  // 199: inventory.v1.ChangeAgentResponse.rta_mongodb_agent:type_name -> inventory.v1.RTAMongoDBAgent
	4,   // 200: inventory.v1.ChangeAgentResponse.otel_collector:type_name -> inventory.v1.OtelCollector
	11,  // 201: inventory.v1.ChangeAgentResponse.clickhouse_exporter:type_name -> inventory.v1.ClickHouseExporter
	12,  // 202: inventory.v1.ChangeAgentResponse.qan_clickhouse_querylog_agent:type_name -> inventory.v1.QANClickHouseQueryLogAgent
	101, // 203: inventory.v1.AddPMMAgentParams.custom_labels:type_name -> inventory.v1.AddPMMAgentParams.CustomLabelsEntry
	102, // 204: inventory.v1.AddNodeExporterParams.custom_labels:type_name -> inventory.v1.AddNodeExporterParams.CustomLabelsEntry
	126, // 205: inventory.v1.AddNodeExporterParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 206: inventory.v1.ChangeNodeExporterParams.custom_labels:type_name -> common.StringMap
	127, // 207: inventory.v1.ChangeNodeExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 208: inventory.v1.ChangeNodeExporterParams.log_level:type_name -> inventory.v1.LogLevel
	103, // 209: inventory.v1.AddMySQLdExporterParams.custom_labels:type_name -> inventory.v1.AddMySQLdExporterParams.CustomLabelsEntry
	126, // 210: inventory.v1.AddMySQLdExporterParams.log_level:type_name -> inventory.v1.LogLevel
	104, // 211: inventory.v1.AddMySQLdExporterParams.extra_dsn_params:type_name -> inventory.v1.AddMySQLdExporterParams.ExtraDsnParamsEntry
	128, // 212: inventory.v1.AddMySQLdExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	129, // 213: inventory.v1.ChangeMySQLdExporterParams.custom_labels:type_name -> common.StringMap
	127, // 214: inventory.v1.ChangeMySQLdExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 215: inventory.v1.ChangeMySQLdExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 216: inventory.v1.ChangeMySQLdExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	105, // 217: inventory.v1.AddMongoDBExporterParams.custom_labels:type_name -> inventory.v1.AddMongoDBExporterParams.CustomLabelsEntry
	126, // 218: inventory.v1.AddMongoDBExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 219: inventory.v1.AddMongoDBExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	129, // 220: inventory.v1.ChangeMongoDBExporterParams.custom_labels:type_name -> common.StringMap
	127, // 221: inventory.v1.ChangeMongoDBExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 222: inventory.v1.ChangeMongoDBExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 223: inventory.v1.ChangeMongoDBExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	106, // 224: inventory.v1.AddPostgresExporterParams.custom_labels:type_name -> inventory.v1.AddPostgresExporterParams.CustomLabelsEntry
	126, // 225: inventory.v1.AddPostgresExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 226: inventory.v1.AddPostgresExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	129, // 227: inventory.v1.ChangePostgresExporterParams.custom_labels:type_name -> common.StringMap
	127, // 228: inventory.v1.ChangePostgresExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 229: inventory.v1.ChangePostgresExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 230: inventory.v1.ChangePostgresExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	107, // 231: inventory.v1.AddProxySQLExporterParams.custom_labels:type_name -> inventory.v1.AddProxySQLExporterParams.CustomLabelsEntry
	126, // 232: inventory.v1.AddProxySQLExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 233: inventory.v1.AddProxySQLExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	129, // 234: inventory.v1.ChangeProxySQLExporterParams.custom_labels:type_name -> common.StringMap
	127, // 235: inventory.v1.ChangeProxySQLExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 236: inventory.v1.ChangeProxySQLExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 237: inventory.v1.ChangeProxySQLExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	108, // 238: inventory.v1.AddQANMySQLPerfSchemaAgentParams.custom_labels:type_name -> inventory.v1.AddQANMySQLPerfSchemaAgentParams.CustomLabelsEntry
	126, // 239: inventory.v1.AddQANMySQLPerfSchemaAgentParams.log_level:type_name -> inventory.v1.LogLevel
	109, // 240: inventory.v1.AddQANMySQLPerfSchemaAgentParams.extra_dsn_params:type_name -> inventory.v1.AddQANMySQLPerfSchemaAgentParams.ExtraDsnParamsEntry
	129, // 241: inventory.v1.ChangeQANMySQLPerfSchemaAgentParams.custom_labels:type_name -> common.StringMap
	127, // 242: inventory.v1.ChangeQANMySQLPerfSchemaAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 243: inventory.v1.ChangeQANMySQLPerfSchemaAgentParams.log_level:type_name -> inventory.v1.LogLevel
	110, // 244: inventory.v1.AddQANMySQLSlowlogAgentParams.custom_labels:type_name -> inventory.v1.AddQANMySQLSlowlogAgentParams.CustomLabelsEntry
	126, // 245: inventory.v1.AddQANMySQLSlowlogAgentParams.log_level:type_name -> inventory.v1.LogLevel
	111, // 246: inventory.v1.AddQANMySQLSlowlogAgentParams.extra_dsn_params:type_name -> inventory.v1.AddQANMySQLSlowlogAgentParams.ExtraDsnParamsEntry
	129, // 247: inventory.v1.ChangeQANMySQLSlowlogAgentParams.custom_labels:type_name -> common.StringMap
	127, // 248: inventory.v1.ChangeQANMySQLSlowlogAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 249: inventory.v1.ChangeQANMySQLSlowlogAgentParams.log_level:type_name -> inventory.v1.LogLevel
	112, // 250: inventory.v1.AddQANMongoDBProfilerAgentParams.custom_labels:type_name -> inventory.v1.AddQANMongoDBProfilerAgentParams.CustomLabelsEntry
	126, // 251: inventory.v1.AddQANMongoDBProfilerAgentParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 252: inventory.v1.ChangeQANMongoDBProfilerAgentParams.custom_labels:type_name -> common.StringMap
	127, // 253: inventory.v1.ChangeQANMongoDBProfilerAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 254: inventory.v1.ChangeQANMongoDBProfilerAgentParams.log_level:type_name -> inventory.v1.LogLevel
	113, // 255: inventory.v1.AddQANMongoDBMongologAgentParams.custom_labels:type_name -> inventory.v1.AddQANMongoDBMongologAgentParams.CustomLabelsEntry
	126, // 256: inventory.v1.AddQANMongoDBMongologAgentParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 257: inventory.v1.ChangeQANMongoDBMongologAgentParams.custom_labels:type_name -> common.StringMap
	127, // 258: inventory.v1.ChangeQANMongoDBMongologAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 259: inventory.v1.ChangeQANMongoDBMongologAgentParams.log_level:type_name -> inventory.v1.LogLevel
	114, // 260: inventory.v1.AddQANPostgreSQLPgStatementsAgentParams.custom_labels:type_name -> inventory.v1.AddQANPostgreSQLPgStatementsAgentParams.CustomLabelsEntry
	126, // 261: inventory.v1.AddQANPostgreSQLPgStatementsAgentParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 262: inventory.v1.ChangeQANPostgreSQLPgStatementsAgentParams.custom_labels:type_name -> common.StringMap
	127, // 263: inventory.v1.ChangeQANPostgreSQLPgStatementsAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 264: inventory.v1.ChangeQANPostgreSQLPgStatementsAgentParams.log_level:type_name -> inventory.v1.LogLevel
	115, // 265: inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams.custom_labels:type_name -> inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams.CustomLabelsEntry
	126, // 266: inventory.v1.AddQANPostgreSQLPgStatMonitorAgentParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 267: inventory.v1.ChangeQANPostgreSQLPgStatMonitorAgentParams.custom_labels:type_name -> common.StringMap
	127, // 268: inventory.v1.ChangeQANPostgreSQLPgStatMonitorAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 269: inventory.v1.ChangeQANPostgreSQLPgStatMonitorAgentParams.log_level:type_name -> inventory.v1.LogLevel
	116, // 270: inventory.v1.AddRDSExporterParams.custom_labels:type_name -> inventory.v1.AddRDSExporterParams.CustomLabelsEntry
	126, // 271: inventory.v1.AddRDSExporterParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 272: inventory.v1.ChangeRDSExporterParams.custom_labels:type_name -> common.StringMap
	127, // 273: inventory.v1.ChangeRDSExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 274: inventory.v1.ChangeRDSExporterParams.log_level:type_name -> inventory.v1.LogLevel
	117, // 275: inventory.v1.AddExternalExporterParams.custom_labels:type_name -> inventory.v1.AddExternalExporterParams.CustomLabelsEntry
	129, // 276: inventory.v1.ChangeExternalExporterParams.custom_labels:type_name -> common.StringMap
	127, // 277: inventory.v1.ChangeExternalExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	118, // 278: inventory.v1.AddAzureDatabaseExporterParams.custom_labels:type_name -> inventory.v1.AddAzureDatabaseExporterParams.CustomLabelsEntry
	126, // 279: inventory.v1.AddAzureDatabaseExporterParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 280: inventory.v1.ChangeAzureDatabaseExporterParams.custom_labels:type_name -> common.StringMap
	127, // 281: inventory.v1.ChangeAzureDatabaseExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 282: inventory.v1.ChangeAzureDatabaseExporterParams.log_level:type_name -> inventory.v1.LogLevel
	119, // 283: inventory.v1.AddValkeyExporterParams.custom_labels:type_name -> inventory.v1.AddValkeyExporterParams.CustomLabelsEntry
	126, // 284: inventory.v1.AddValkeyExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 285: inventory.v1.AddValkeyExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	129, // 286: inventory.v1.ChangeValkeyExporterParams.custom_labels:type_name -> common.StringMap
	127, // 287: inventory.v1.ChangeValkeyExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 288: inventory.v1.ChangeValkeyExporterParams.log_level:type_name -> inventory.v1.LogLevel
	128, // 289: inventory.v1.ChangeValkeyExporterParams.connection_timeout:type_name -> google.protobuf.Duration
	120, // 290: inventory.v1.AddClickHouseExporterParams.custom_labels:type_name -> inventory.v1.AddClickHouseExporterParams.CustomLabelsEntry
	126, // 291: inventory.v1.AddClickHouseExporterParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 292: inventory.v1.ChangeClickHouseExporterParams.custom_labels:type_name -> common.StringMap
	127, // 293: inventory.v1.ChangeClickHouseExporterParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 294: inventory.v1.ChangeClickHouseExporterParams.log_level:type_name -> inventory.v1.LogLevel
	121, // 295: inventory.v1.AddQANClickHouseQueryLogAgentParams.custom_labels:type_name -> inventory.v1.AddQANClickHouseQueryLogAgentParams.CustomLabelsEntry
	126, // 296: inventory.v1.AddQANClickHouseQueryLogAgentParams.log_level:type_name -> inventory.v1.LogLevel
	129, // 297: inventory.v1.ChangeQANClickHouseQueryLogAgentParams.custom_labels:type_name -> common.StringMap
	127, // 298: inventory.v1.ChangeQANClickHouseQueryLogAgentParams.metrics_resolutions:type_name -> common.MetricsResolutions
	126, // 299: inventory.v1.ChangeQANClickHouseQueryLogAgentParams.log_level:type_name -> inventory.v1.LogLevel
	122, // 300: inventory.v1.AddRTAMongoDBAgentParams.custom_labels:type_name -> inventory.v1.AddRTAMongoDBAgentParams.CustomLabelsEntry
	126, // 301: inventory.v1.AddRTAMongoDBAgentParams.log_level:type_name -> inventory.v1.LogLevel
	17,  // 302: inventory.v1.AddRTAMongoDBAgentParams.rta_options:type_name -> inventory.v1.RTAOptions
	123, // 303: inventory.v1.AddOtelCollectorParams.custom_labels:type_name -> inventory.v1.AddOtelCollectorParams.CustomLabelsEntry
	72,  // 304: inventory.v1.AddOtelCollectorParams.log_sources:type_name -> inventory.v1.LogSource
	124, // 305: inventory.v1.ChangeOtelCollectorParams.merge_labels:type_name -> inventory.v1.ChangeOtelCollectorParams.MergeLabelsEntry
	72,  // 306: inventory.v1.ChangeOtelCollectorParams.add_log_sources:type_name -> inventory.v1.LogSource
	72,  // 307: inventory.v1.ChangeOtelCollectorParams.set_log_sources:type_name -> inventory.v1.LogSource
	129, // 308: inventory.v1.ChangeRTAMongoDBAgentParams.custom_labels:type_name -> common.StringMap
	126, // 309: inventory.v1.ChangeRTAMongoDBAgentParams.log_level:type_name -> inventory.v1.LogLevel
	17,  // 310: inventory.v1.ChangeRTAMongoDBAgentParams.rta_options:type_name -> inventory.v1.RTAOptions
	25,  // 311: inventory.v1.AgentsService.ListAgents:input_type -> inventory.v1.ListAgentsRequest
	27,  // 312: inventory.v1.AgentsService.GetAgent:input_type -> inventory.v1.GetAgentRequest
	29,  // 313: inventory.v1.AgentsService.GetAgentLogs:input_type -> inventory.v1.GetAgentLogsRequest
	31,  // 314: inventory.v1.AgentsService.AddAgent:input_type -> inventory.v1.AddAgentRequest
	33,  // 315: inventory.v1.AgentsService.ChangeAgent:input_type -> inventory.v1.ChangeAgentRequest
	76,  // 316: inventory.v1.AgentsService.RemoveAgent:input_type -> inventory.v1.RemoveAgentRequest
	26,  // 317: inventory.v1.AgentsService.ListAgents:output_type -> inventory.v1.ListAgentsResponse
	28,  // 318: inventory.v1.AgentsService.GetAgent:output_type -> inventory.v1.GetAgentResponse
	30,  // 319: inventory.v1.AgentsService.GetAgentLogs:output_type -> inventory.v1.GetAgentLogsResponse
	32,  // 320: inventory.v1.AgentsService.AddAgent:output_type -> inventory.v1.AddAgentResponse
	34,  // 321: inventory.v1.AgentsService.ChangeAgent:output_type -> inventory.v1.ChangeAgentResponse
	77,  // 322: inventory.v1.AgentsService.RemoveAgent:output_type -> inventory.v1.RemoveAgentResponse
	317, // [317:323] is the sub-list for method output_type
	311, // [311:317] is the sub-list for method input_type
...
func file_inventory_v1_agents_proto_init() {
	...
	file_inventory_v1_agents_proto_msgTypes[69].OneofWrappers = []any{}
	file_inventory_v1_agents_proto_msgTypes[73].OneofWrappers = []any{}
	file_inventory_v1_agents_proto_msgTypes[74].OneofWrappers = []any{}
	type x struct{}
